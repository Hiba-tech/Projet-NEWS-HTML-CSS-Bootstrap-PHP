...
<head>
  ...
  <link href="cssformpaye.css" rel="stylesheet">
...
<body>
<div class="jumbotron text-center" style="margin-bottom:0; background-image: url(images/biblio.jpeg); background-repeat: no-repeat; background-size: 500px; background-size: cover;" >
    <h1> WORLD NEWS</h1>
    <p>Forgez vous votre propre opinion </p>
        ...
        <!---------------------------------------------------------------LA BARE DU MENU-------------------------------------------------------------->
<nav class="navbar navbar-expand-sm  navbar-dark" style="background-color: black; justify-content: center;">
  <a class="navbar-brand" href="#" style="font-size: 2em;">WORLD NEWS</a>
  
</nav>
<!-- Tab panes -->
  <div class="tab-content" style="background-color: rgba(127,127,127,0.5);">
