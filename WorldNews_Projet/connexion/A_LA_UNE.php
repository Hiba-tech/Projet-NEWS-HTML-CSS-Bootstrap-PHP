...
<div class="container" style="margin-top:30px;">
  <div class="row">
    ...
    <div class="col-sm-5">
      ...
      <div class="col-sm-12">
      <!---Mon profil--->
      <button type="submit" class="btn btn-primary"><a href="../editionprofil.php" style="text-decoration: none; color: rgb(255,255,255);"> Editer mon profil</a></button></br>

      <!---Se déconnecter--->
      <button type="submit" class="btn btn-primary"><a href="../seconnecter.php" style="text-decoration: none; color: rgb(255,255,255);">Se déconnecter </a></button></br>
      </div>
      </div>
