...
--->
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="nav nav-pills col-6" role="tablist" >
      ...
      <li class="nav-item active"> <a class="nav-link" href="connexion/A_LA_UNE.php" style="color: navy; font-weight: bold;">A LA UNE <span class="sr-only">(current)</span></a> </li>
...
<!---FIN NAVBAR ---->
   ...
   <br> 
    <div align ="center">
             <h2 style="color: navy; font-family: cursive; font-size: 20px; font-weight: bold;"> Bienvenue <?php echo $userinfo['nom_utilisateur'].' '. $userinfo['pn_utilisateur']; ?> ! </h2>
...
<div class="container" style="margin-top:30px;">
  <div class="row">
   ...
   <div class="col-sm-5">
      <div id="inscri" class="row text-center" style="background-color: #EAB60A;">
      <div class="col-sm-12" style=" ">
      <!---Mon profil--->
      <button type="submit" class="btn btn-primary" style="background-color: #1c1a19;"><a href="editionprofil.php" style="text-decoration: none; color: rgb(255,255,255); "> Editer mon profil</a></button></br>

      <!---Se déconnecter--->
      <button type="submit" class="btn btn-primary" style="background-color: #1c1a19;"><a href="seconnecter.php" style="text-decoration: none; color: rgb(255,255,255);">Se déconnecter </a></button></br>
      </div>
      </div>
