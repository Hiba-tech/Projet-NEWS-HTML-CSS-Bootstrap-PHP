    ...
    <div class="col-sm-5">
      ...
      <div class="col-sm-12">
       ...
       <form method="POST" action="seconnecter.php">
        <input type="submit" name="seconnecter" value="Se connecter" style="color: navy; font-weight: bold; background-color: #EAB60A; width: 120px; height: 30px;" >
    </form>
    </br>
    <!---s'inscrire--->
    <form>
      <input type="submit" name="sinscrire" value="S'inscrire" style="color: navy; font-weight: bold; background-color: #EAB60A; width: 120px; height: 30px;" >
