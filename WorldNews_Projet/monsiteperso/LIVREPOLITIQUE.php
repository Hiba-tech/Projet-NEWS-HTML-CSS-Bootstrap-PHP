...
<body>
      ...
      <header>
        ...
        <!--BOUTONS -->   
            <div id="utilisateur">
              <form
            <button type="button" class="btn btn-warning"style="width: 50px";><span class="fa fa-user" onclick(window.location='enregistrement.php'/> <span></button>
            </div>
          </form>
            <div id="coeur">
